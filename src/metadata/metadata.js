...
- Built Datapharm's first-generation "golden path": templated, extensible CI/CD pipelines and Terraform module patterns for Container Apps to enable self-service.
...
- Led an AWS/Terraform refactor to deliver a production-ready Kubernetes platform, improving reliability and infrastructure consistency across environments.`
    }
  ],
  projects: [
    {
